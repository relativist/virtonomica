 ...
 */
public class FitnesPage extends Page {
    public FitnesPage(WebDriver driver_out) {
        super();
        driver = driver_out;
    }

    public FitnesPage educate(){
   ...
   public FitnesPage finans(){
       ...
       driver.findElement(By.xpath("//a[text()='Фитнес-центр']")).click();
       return new FitnesPage(driver);
   }
    ...
    */
    ...
    public FitnesPage supplyProductsWithSuppliers(){
    ...
    public FitnesPage setAutoQaSlave() throws InterruptedException {
